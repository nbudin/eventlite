        ...
        <div className="row">
          <div className="col">
            <div className="form-group">
              ...
              <div className="row">
                <div className="col">
                  <input type="tel" value={this.props.expMonth} onChange={this.props.onExpMonthChanged} className="form-control" size="2" placeholder="MM" />
                </div>
                <div className="col">
                  <input type="tel" value={this.props.expYear} onChange={this.props.onExpYearChanged} className="form-control" size="4" placeholder="YYYY" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="col">
            <div className="form-group">
              ...
              <input type="tel" id={cvcId} value={this.props.cvc} onChange={this.props.onCvcChanged} className="form-control" placeholder="•••" />
            </div>
          </div>
          ...
          <div className="col">
            <div className="form-group">
              ...
              <input type="tel" id={zipId} value={this.props.zip} onChange={this.props.onZipChanged} className="form-control" placeholder="" />
            </div>
          </div>
        </div>
      </div>
